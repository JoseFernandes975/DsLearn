...
public class NotificationResource {
	...
	@GetMapping
	public ResponseEntity<Page<NotificationDTO>> notificationForUserLoged(@RequestParam(name = "unreadOnly", defaultValue = "false") Boolean unreadOnly, Pageable pageable){
